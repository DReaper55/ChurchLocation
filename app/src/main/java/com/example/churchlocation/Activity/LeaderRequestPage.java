...
public class LeaderRequestPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_leader_request_page, container, false);
    }
        ...
        db.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    DatabaseReference db = firebaseDatabase.getReference("leaderVerification/" + country);
                    db.addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                            if(dataSnapshot.exists()){
                                ...
                                recyclerView = view.findViewById(R.id.leaderRequestsRecycler);
                                recyclerView.setHasFixedSize(true);
                                recyclerView.setLayoutManager(new LinearLayoutManager(ctx));

                                adapter = new SearchUserRequestsAdapter(ctx, userObjectList, 1, recyclerView);
